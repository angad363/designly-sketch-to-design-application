...
const Page = async ({searchParams}: Props) => {
  ...
  const existingMoodboardImages = await MoodBoardImageQuery(projectId)
          ...
          <div className='space-y-8'>
            <div className='text-center py-20'>
              ...
              <p className='text-sm text-muted-foreground max-w-md mx-auto mb-6'>
                Upload images to your mood board and generate AI-powered style guide with colours and typography.
              </p>
            </div>
          </div>
        ): (
