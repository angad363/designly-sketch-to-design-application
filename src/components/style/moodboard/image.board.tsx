  ...
  >
    <div className='relative w-40 h-48 rounded-2xl overflow-hidden bg-white shadow-xl border border-border/20 hover:scale-105 transition-all duration-200'>
        ...
        <Button
            ...
            className='absolute top-2 right-2 w-6 h-6 bg-black/50 hover:bg-black/70 rounded-full items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity'
        >
